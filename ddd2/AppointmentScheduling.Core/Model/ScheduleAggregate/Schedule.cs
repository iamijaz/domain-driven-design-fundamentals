...
namespace AppointmentScheduling.Core.Model.ScheduleAggregate
{
    public class Schedule : Entity<Guid>//, IHandle<AppointmentUpdatedEvent>
    {
        ...
        public Schedule(Guid id, DateTimeRange dateRange, int clinicId)
            : base(id)
        {
            DateRange = dateRange;
            ClinicId = clinicId;
        ...
        public void AddExistingAppointments(IEnumerable<Appointment> appointments)
        {
            appointments.ToList().ForEach(a => _appointments.Add(a));
